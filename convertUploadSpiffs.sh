...
python /home/klemen/esp/esp-idf/components/esptool_py/esptool/esptool.py --chip esp32 --port /dev/ttyS9 --baud 921600 --before default_reset --after hard_reset write_flash -z --flash_mode dio --flash_freq 40m --flash_size detect 0x291000 ./spiffs.bin
